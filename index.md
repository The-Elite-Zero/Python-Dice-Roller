...
def roll_d10(rolls):
    ...
    for x in range (0, rolls):
        roll_list.append(random.randint(1,10))
...
def roll_d8(rolls):
    ...
    print("\n")
    print("Rolling d8, ", rolls, " time(s)")
    print("\n")
    roll_list = []
    
    for x in range (0, rolls):
        roll_list.append(random.randint(1,8))
...
def roll_d4(rolls):
    ...
    print("\n")
    print("Rolling d4, ", rolls, " time(s)")
    print("\n")
    roll_list = []
    
    for x in range (0, rolls):
        roll_list.append(random.randint(1,4))
...
def roll_d2(rolls):
    ...
    print("\n")
    print("Rolling d2, ", rolls, " time(s)")
    print("\n")
    roll_list = []
    
    for x in range (0, rolls):
        roll_list.append(random.randint(1,2))
...
def roll_d100(rolls):
    ...
    print("\n")
    print("Rolling d100, ", rolls, " time(s)")
    print("\n")
    roll_list = []
    
    for x in range (0, rolls):
        roll_list.append(random.randint(1,100))
...
def dice_choice(dice, amount):
    ...
    #print("User's Choice: ", dice, amount)
